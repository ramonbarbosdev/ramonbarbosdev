...
Sou desenvolvedor com foco em construção de sistemas completos, atuando principalmente com **Angular + Tailwind no frontend**, **React Native** e **Spring Boot + Spring AI no backend**, **PHP**.

Tenho forte preocupação com:
- arquitetura limpa e escalável  
- experiência do usuário (UI/UX moderna estilo SaaS)  
- performance e organização de código  
- integração de inteligência artificial em aplicações reais  

Atualmente, estou desenvolvendo projetos voltados para **assistentes inteligentes, sistemas empresariais e aplicações multi-tenant**.
...
- Criação de frameworks e abstrações próprias
- Integração de IA em aplicações reais
- Sistemas multi-tenant com autenticação robusta
- Construção de interfaces modernas (SaaS / mobile)
...
Este perfil é focado em demonstrar projetos reais e aplicáveis ao mercado, com ênfase em arquitetura, experiência do usuário e uso prático de inteligência artificial.
